...
(class_train_y, class_test_y, class_train_prop_y, class_test_prop_y)=learner.random_forest(
    X_train[feature_set_4],y_train,X_test[feature_set_4],gridsearch=True
)

accuracy=accuracy_score(y_test,class_test_y)

classes=class_test_prop_y.columns
...
y_train=participant_df[participant_df['participant']!='A'].drop('label')

X_test=participant_df[participant_df['participant']=='A'].drop('label',axis=1)
y_test=participant_df[participant_df['participant']=='A'].drop('label')
